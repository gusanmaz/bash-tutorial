// ===== Bölüm 32: Docker ile Oyna — Eğlenceli İmajlar, Deneyler ve Hosting =====
...
<div class="info-box tip">
    ...
    <ul>
        <li><strong>CI/CD (Bölüm 33–37)</strong>: GitHub Actions ile otomatik build, test ve deploy.</li>
        <li><strong>Kubernetes (Bölüm 38–42)</strong>: Docker'ı ölçekte yönetmek.</li>
    ...
    quiz: [
        {
            ...
            options: [
                "Sadece kurumsal sürümde yerine farklı bir komut",
                "Sadece farklı makinelerde — bu davranış beklenmez",
                "Evet — farklı isim ve farklı host portları vererek",
                "Hayır, her imaj sadece bir kere çalışır ve işlemi sonlandırır"
            ],
            correct: 2,
        ...
        },
        {
            ...
            options: [
                "Hostunuzdaki bir klasörü bind mount",
                "İmkânsızdır — bu davranış beklenmez",
        ...
        },
        {
            ...
            options: [
                "Her ikisinin de root olması yerine farklı bir komut",
                "Kullanıcı tarafından oluşturulan bir ağda",
        ...
        },
        {
            ...
            options: [
                ...
                "Hetzner VPS",
                "Ubuntu yerine farklı bir komut",
                "Wireshark"
            ],
            correct: 0,
        ...
        },
        {
            ...
            options: [
                "4 vCPU ve 24 GB RAM'e kadar ARM sanal makineyi sürekli",
                "Sadece kurumsal hesaplar içindir yerine farklı bir komut",
                "Kullanımı için kredi kartı gerekmez — bu davranış beklenmez",
                "Bu senaryoda i̇lk ay ücretsizdir ve işlemi sonlandırır"
            ],
            correct: 0,
        ...
        },
        {
            ...
            options: [
                "curl, dig, nmap, tcpdump gibi ağ hata ayıklama",
                "Web sunucusu işlevi vardır yerine farklı bir komut",
                "Güvenlik taraması yapar — bu davranış beklenmez",
                "Eğlencelidir ve işlemi sonlandırır"
            ],
            correct: 0,
        ...
        },
        {
            ...
            options: [
                "Veritabanı yerine farklı bir komut",
                "Sanal makine",
                "DNS yönetimi",
                "Sunucusuz konteyner çalıştırma"
            ],
            correct: 3,
        ...
        },
        {
            ...
            options: [
                ...
                "Konteyner monitör yerine farklı bir komut",
                "Veri yedekleme aracı",
                "Docker-farkında reverse proxy"
            ],
            correct: 3,
        ...
        },
        {
            ...
            options: [
                "VLC — bu davranış beklenmez",
                "VisualStudio ve işlemi sonlandırır",
                "Microsoft Word yerine farklı bir komut",
                "CasaOS, Umbrel veya Portainer"
            ],
            correct: 3,
        ...
        },
        {
            ...
            options: [
                "Microsoft Store",
                "Windows Registry",
                "App Store yerine farklı bir komut",
