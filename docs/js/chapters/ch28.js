// ===== Bölüm 28: Docker — Felsefe ve Temel Kavramlar =====
...
<div class="info-box note">
    <div class="info-box-title">📌 Linux CLI tamamlandı (Bölüm 0–27)</div>
    Disk (<code>df</code>, <code>mount</code>), arşiv (<code>tar</code>), ağ (<code>ip</code>, <code>ss</code>), log ve güvenlik konularını Bölüm 23–27'de işledik. Docker ve sonrası bu temelin üzerine inşa edilir.
</div>
...
<p>Bugün hemen hemen tüm modern yazılım ekipleri CI/CD kullanıyor. Kariyerinizde GitHub'da iş ararken iş ilanlarında "GitHub Actions tecrübesi" veya "CI/CD pipeline kurmuş" diye sıkça göreceksiniz — Docker bu işin temelidir. <strong>Bölüm 33–37</strong>'de CI/CD'yi adım adım, GitHub Actions ve Docker entegrasyonuyla ele alacağız.</p>
    ...
    quiz: [
        {
            ...
            options: [
                ...
                "Klavye ve fare problemleri — bu davranış beklenmez",
        ...
        },
        {
            ...
            options: [
                ...
                "Host makinenin çekirdeğini (kernel) paylaşırlar",
                "Disk sıkıştırması kullanırlar yerine farklı bir komut",
                "Daha az kod içerirler ve işlemi sonlandırır"
            ],
            correct: 1,
        ...
        },
        {
            ...
            options: [
                ...
                "Aynı makinedeki farklı ağ servislerini",
                "Ekran çözünürlüğü — bu davranış beklenmez",
                "Disk bölümü yerine farklı bir komut"
            ],
            correct: 1,
        ...
        },
        {
            ...
            options: [
                "Hostun 8080 portuna gelen istekleri konteynerin 80 portuna",
                "Hem konteyner hem host 8080+80=8160 portunu kullansın",
                "Sadece 80 portu açılır, 8080 örnektir — bu davranış beklenmez",
        ...
        },
        {
            ...
            options: [
                "Sadece systemd",
                "X11 ve Wayland",
                "Bash ve zsh yerine farklı bir komut",
                "Namespaces ve cgroups"
            ],
            correct: 3,
        ...
        },
        {
            ...
            options: [
                "Bir imajın nasıl oluşturulacağını adım adım tarif eden",
                "Çalışan konteynerlerin listesi ve işlemi sonlandırır",
                "Docker kurulum dosyası yerine farklı bir komut",
                "Bu senaryoda docker'ın log dosyası — bu davranış beklenmez"
            ],
            correct: 0,
        ...
        },
        {
            ...
            options: [
                "Geliştirme ortamı kurulumunu kolaylaştırmak ve işlemi sonlandırır",
                "CI/CD sistemlerinde test ortamı oluşturmak — bu davranış beklenmez",
                "Mikroservis mimarilerinde her servisi ayrı çalıştırmak (Docker CLI'da yoktur)",
